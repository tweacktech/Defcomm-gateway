...
class CallAnswered implements ShouldBroadcast
{
    ...
    {
        return ['peer_id' => $this->participant->peer_id, 'display_name' => $this->participant->display_name, 'role' => $this->participant->role, 'audio_on' => $this->participant->audio_on];
    }
}
